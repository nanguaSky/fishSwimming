...
public class GraphView extends View {
    ...
    private void initView() {
        height = getHeight();
        width = getWidth();
        hosMargin = dip2px(context, HOS_MARGIN);
        verMargin = dip2px(context, VER_MARGIN);
        paint = new Paint();
    ...
    private void drawPoint(Canvas canvas) {
        ...
        int yOffset = dip2px(context, POINT_TEXT_OFFSET);
    ...
    private void drawXValue(Canvas canvas) {
        ...
        paint.setTextSize(dip2px(context, X_VALUE_TEXTSIZE));
    ...
    private void drawGraphAxis(Canvas canvas) {
        ...
        paint.setStrokeWidth(dip2px(context, AXIS_LINE_WIDTH));
        paint.setStyle(Paint.Style.STROKE);
