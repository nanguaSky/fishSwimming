...
public class SuperLikeLayout extends View implements AnimationEndListener{
    ...
    private static final int ERUPTION_ELEMENT_AMOUNT = 12;
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        hasTextAnimation = a.getBoolean(R.styleable.SuperLikeLayout_show_text, false);
        a.recycle();
    ...
    public void draw(Canvas canvas) {
        ...
        for (int i = runningFrameList.size() - 1; i >= 0; i--) {
            ...
            for(Element element : elementList){
                LogUtil.i("hc", "element.getAlpha()  : " + element.getAlpha() );
