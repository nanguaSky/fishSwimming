...
public final class PermissionUtil {
     ...
     */
    public static PermissionUtil permission(Context context, @PermissionConstants.Permission final String... permissions) {
        return new PermissionUtil(context, permissions);
    }

    private PermissionUtil(Context context, final String... permissions) {
