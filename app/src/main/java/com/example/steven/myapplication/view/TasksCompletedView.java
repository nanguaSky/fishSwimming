...
public class TasksCompletedView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRadius = typeArray.getDimension(R.styleable.TasksCompletedView_TRadius, 80);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mXCenter, mYCenter, mRadius + 10, mCirclePaint);
        ...
        if (mProgress > 0) {
            ...
            canvas.drawArc(oval, -90, ((float) mProgress / mTotalProgress) * 360, true,
                    mRingPaint); //
        }
    }
